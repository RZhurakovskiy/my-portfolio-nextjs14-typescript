        ...
        <div className="inner-page-details">
          ...
          <div className="inner-page-text">
            ...
            <div className="description-project">
              <p className="description-project-title">Реализовано:</p>

              <p>- Определение геолокации пользователя по нажатию кнопки.</p>
              <p>
                - Индикация уровня заряда батареи и статуса подключения
